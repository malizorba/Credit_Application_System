...
//    @PutMapping("/addApply/Customer/{id}")
//    public ResponseEntity addCreditApllytoCustomer(
//            @PathVariable String nationalIdentityNumber,
//            @RequestBody CreditApplication creditApplication){
//        Customer customer=customerService.AddApply(nationalIdentityNumber, creditApplication);
